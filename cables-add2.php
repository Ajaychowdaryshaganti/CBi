...
error_reporting(E_ALL);
    ...
    $query = "INSERT INTO `cables`(`BinLocation`, `PartName`, `PartNo`, `Length`, `MaxStock`, `MinStock`, `LastUpdated`, `Category`) VALUES('$binlocation', '$partname', '$partno', '$length', '$MaxStock', '$MinStock',Now(),'Cables' )";
   ...
   $msg="Error: " . $e->getMessage();
								...
								<form method=\"post\" id=\"myForm\" action=\"cables-add2.php\">
									...
									<label> Reel Length (Mts): </label>
									<div class=\"input-field\" id=\"idFld1\"> 
									<input type=\"text\" id=\"supplier\"  name=\"length\"></div>
									<label> Max (No's): </label>
									<div class=\"input-field\" id=\"idFld2\"> 
									<input type=\"number\" id=\"max\"  name=\"MaxStock\"></div>
									<label> Min (No's): </label>
									<div class=\"input-field\" id=\"idFld3\"> 
									<input type=\"number\" id=\"min\"  name=\"MinStock\"></div>
