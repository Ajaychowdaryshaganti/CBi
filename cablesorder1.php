...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM cables WHERE PartNo = '$partno'";
...
<section id="page-top-2">
    ...
    <br>
    <h4 class="white-txt center"><center><strong>Welcome to Cable Re-Order Console</strong></center></h4>
</section>
  ...
  <form method=\"post\" id=\"myForm\" onkeydown=\"disableEnterKey(event)\" action=\"\">
    <div class=\"signup-container\">
      ...
      <div class=\"form-cube\">
        ...
        <h4><strong>Reel Length (Mts): </strong> " . $Length . "</h4><br>
        <h4><strong>Max Stock (No's): </strong> " . $Max . "</h4><br>
        <h4><strong>Min Stock (No's): </strong> " . $Min . "</h4><br>
        <h1 id=\"heading\">Enter No of Reels to be Ordered</h1>
        <div class=\"input-field\" id=\"idFld\">
          <input type=\"number\" id=\"quantity\" name=\"effectedquantity\" autofocus>
        </div>
        <button id=\"fill\" class=\"used\" type=\"button\" onclick=\"submitForm('cablesorder2.php')\">Order</button>
		<br>
		<br>
		<br>
		<button id=\"fill-green\" class=\"receive\" type=\"button\" onclick=\"receive('$PartNo')\">Receive</button><br><br><br>
		<button id=\"no-fill\"}><strong><a href=\"validateusercables.php?password=" . urlencode($password) . "\" style=\"margin-left:0%;\"> &#x1F50D Scan New Item</a><strong></button><br>
      </div>
      <center>
        <a id=\"\" class=\"ri-logout-circle-line\" href=\"cablesindex.html\">Logout</a>
      </center>
    </div>
  </form>    ";
} else {
    ...
    <form method=\"post\" id=\"myForm\" action=\"cablesorder1.php\">
        ...
        <div class=\"signup-container\">
          ...
          <h3 id=\"heading\">Scan/Enter the Cable PartNo</h3>
            ...
            </div><center> <a id=\"\" class=\"ri-logout-circle-line\" href=\"cablesindex.html\">Logout</a>
            </center>     
        </div>
    </form>
    ";
	...
	$flag1 = 0;
	$BackOrder=0;
    $query1 = "SELECT BackOrder FROM reordercables WHERE PartNo = '$partno'";
...
function receive(partNo) {
    ...
    xhr.open('POST', 'partialOrderReceivedcables.php', true);
