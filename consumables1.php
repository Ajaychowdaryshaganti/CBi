...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "SELECT * FROM consumables WHERE PartNo = '$partno'";
...
<section id="page-top-2">
    ...
    <br>
    <h4 class="white-txt center"><center><strong>Welcome to Consumables Re-Order/Recieve Console</strong></center></h4>
</section>
  ...
  <form method=\"post\" id=\"myForm\" onkeydown=\"disableEnterKey(event)\" action=\"\">
    <div class=\"signup-container\">
      ...
      <div class=\"form-cube\">
        ...
        <button id=\"fill\" class=\"used\" type=\"button\" onclick=\"submitForm('consumables2.php')\">Order</button>
		<br>
		<br>
		<br>
		<button id=\"fill-green\" class=\"receive\" type=\"button\" onclick=\"receive('$PartNo')\">Receive</button><br><br><br>
		<button id=\"no-fill\"}><strong><a href=\"validateuserconsumables.php?password=" . urlencode($password) . "\" style=\"margin-left:0%;\"> &#x1F50D Scan New Item</a><strong></button><br>
      </div>
      <center>
        <a id=\"\" class=\"ri-logout-circle-line\" href=\"consumableslogin.html\">Logout</a>
      </center>
    </div>
  </form>    ";
} else {
    ...
    <form method=\"post\" id=\"myForm\" action=\"consumables1.php\">
        ...
        <div class=\"signup-container\">
          ...
          <h3 id=\"heading\">Scan/Enter the PartNo</h3>
            ...
            </div><center> <a id=\"\" class=\"ri-logout-circle-line\" href=\"consumableslogin.html\">Logout</a>
            </center>     
        </div>
    </form>
    ";
	...
	$flag1 = 0;
	$BackOrder=0;
    $query1 = "SELECT BackOrder FROM reorderconsumables WHERE PartNo = '$partno'";
...
function receive(partNo) {
    ...
    xhr.open('POST', 'partialOrderReceivedconsumables.php', true);
