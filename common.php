...
#loading-animation {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(242, 242, 242, 0.5); /* Set the opacity value here */
  z-index: 9999;
...
<body>
  ...
  </header><div id="loading-animation"><img src="images/loading.png" alt="Loading..." class="spinner"></div></div>
