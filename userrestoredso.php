<script>
    function setDropdownSelection(jobId) {
        const dropdown = document.getElementById('jobid');
        for (let i = 0; i < dropdown.options.length; i++) {
            if (dropdown.options[i].value === jobId) {
        ...
        <div class="signup-container">
            ...
            <div class="form-cube">
                <form method="post" id="myForm" action="userorderso.php">
                    ...
                    <br>
                    <br></div>
					<button id="fill-blue" class="used" type="button" onclick="submitForm('userusageso.php')">Check Usage</button><br><p> You can check the parts used by you under this sales order</p><br>
				...
				<button id="fill-green" class="used" type="button" onclick="submitForm('useraddjobso.php')">Start a new Job</button><p> <center>--- You can only add jobs assigned to you ---</center>
                </form>
            </div>
        </div>
    ...
    <?php else : ?>
      <br><br>
        <div class="signup-container">
            <!-- Box container containing elements -->
            <div class="form-cube">
       <form method="post" id="myForm" action="userusedso.php">
                    ...
                    <button id="fill" class="used" type="button" onclick="submitForm('userusedso.php')">Used</button><br><br>
                    <button id="fill-green" class="restored" type="button" onclick="submitForm('userrestoredso.php')">Restored</button>
                <br>
                    <br>
