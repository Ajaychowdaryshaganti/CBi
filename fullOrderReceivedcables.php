...
if ($conn) {
    try {
        if ($conn) {
            ...
            $InsertQuery = "INSERT INTO orderhistory(BinLocation, PartName, PartNo, Category, Available, Ordered, PurchaseOrder, LastUpdated, Comments) select BinLocation, PartName, PartNo, Category,0,?, PurchaseOrder, LastUpdated, Comments from reordercables WHERE PartNo = ? ";
