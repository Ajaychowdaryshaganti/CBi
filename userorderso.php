...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result1 = mysqli_query($conn, $query1); // Fixed variable name
    ...
    <form method=\"post\" id=\"myForm\" action=\"userusedso.php\">
        <div class=\"signup-container\">
            ...
            <div class=\"form-cube\">
				...
				<br><br><strong><a href=\"validateuserso.php?password=" . urlencode($password) . "\" style=\"margin-left:0%;\"> &#x1F50D Scan New Item</a><strong><br><br><center><a id=\"\" class=\"ri-logout-circle-line\" href=\"userlogin.html\">Logout</a></center>
            </div>
