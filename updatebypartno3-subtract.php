...
if ($conn&&$newquantity) {
	...
	$updateQuery = "UPDATE stock SET Quantity = Quantity - '$newquantity', LastUpdated= '$currentDateTime'  WHERE PartNo = '$partno'";
									...
									if ($record) {
													...
													<div class=\"signup-container\"> 
																...
																"</h3><br><h3><strong>NewQuantity: </strong>" .$record['Quantity'].
																	"<br><br><h1>Scan/Enter the Part No</h1><div class=\"input-field\" id=\"idFld\"> 
