...
<header>
    <nav>
        ...
        <ul>
            ...
            <li><a href="usage.php" id="select"><p>Usage</p></a></li>
...
$binlocation = $_SESSION['bin'];
    ...
    if ($conn) {
        ...
        if ($record) {
            echo "
            <form method=\"post\" id=\"myForm\" action=\"updatebybin3-add.php\">
                <br><br>
                <div class=\"signup-container\">
                    ...
                    <div class=\"form-cube\">
                        <h3><strong>BinLocation: </strong>" . $record['BinLocation'] .
                            ...
                            "</h3><br><br><h1 id=\"heading\">Enter the quantity to be added</h1>
            ...
            <div class=\"signup-container\">
                <div class=\"form-cube\">
                    <h1>Bin Location: " . $binlocation . "<br><br> is not available in the database" . mysqli_error($conn) . "</h1>
                </div>
            </div>";
        }
    } else {
