...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query = "SELECT fittername FROM fitters WHERE password='$userpin' and kanban=1 ";
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            $msg = 'Either you have entered a wrong PIN or you dont have access to this console.Contact Project Manager';
            $flag = 0;
        }
    } else {
