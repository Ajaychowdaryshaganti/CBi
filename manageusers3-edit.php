...
try {
    if ($conn) {
        ...
        $updateQuery = "UPDATE fitters SET ";
        $params = array();
	...
	if (isset($cables) && $cables!== '') {
        ...
        $updateQuery .= "lastupdated = ? WHERE fittername = ?";
        ...
        if ($statement) {
            ...
            if ($result) {
                $msg = "<h3>" . $fittername . " data updated successfully</h3>";
            } else {
    ...
    $msg = "<h4>Something went wrong. Please try again.</h4>";
}
