...
if ($conn&&$newquantity) {
	...
	$updateQuery = "UPDATE stock SET Quantity = Quantity - '$newquantity', LastUpdated= '$currentDateTime' WHERE BinLocation = '$binlocation'";
    ...
    if ($result) {
								...
								$record=mysqli_fetch_assoc($result);
									...
									if ($record) {
													...
													<div class=\"signup-container\"> 
																...
																<div class=\"form-cube\"> 
																<h1 id=\"heading\"><strong>After Updation</strong></h1>
																...
																"</h3><br><h3><strong>NewQuantity: </strong>" .$record['Quantity'].
																	"<br><br><h1>Scan/Enter the BinLocation</h1><div class=\"input-field\" id=\"idFld\"> 
			...
			{
				echo " <div class=\"signup-container\"> 
									<div class=\"form-cube\"><h1> Please enter a valid Number.
									</h1></div></div>";
			}
			else{
