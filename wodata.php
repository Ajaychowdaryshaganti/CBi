...
<body>
    ...
    try {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><th>SEL</th><th>WORK ORDER</th><th>DATE</th><th>TYPE</th><th>DESCRIPTION</th><th>HRS</th><th>REQUIRED DATE</th><th>PART AVA</th><th>DB AVA</th><th>ESC AVA</th><th>FITTER1</th><th>STATUS</th><th>PRIORITY</th><th>BUILT BY</th><th>COMMENTS1</th><th>COMMENTS2</th><th>LAST UPDATED</th><th>LAST UPDATE BY</th><th>FITTER2</th><th>FITTER3</th></tr>";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='date' id='dno'>" . $row['date'] . "</td>";
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='type'>" . $row['type'] . "</td>";
                ...
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='dbavailability'>" . $row['dbavailability'] . "</td>";
                ...
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='fitter1' style='width:5%;'>";
                echo "<select class=\"drops1\" id=\"fitter1" . $row['jobid'] . "\" name=\"fitter1\"  style='$rowColorStyle'>";
                ...
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='currentstate' style='width:6%;'>";
                echo "<select class=\"drops3\" id=\"currentstate" . $row['jobid'] . "\" name=\"currentstate\"  style='$rowColorStyle'>";
                $statusOptions = ["NotAssigned", "InProgress", "Assigned", "Completed", "Tested", "Paused"];
                ...
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='priority'>" . $row['priority'] . "</td>";
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='builtby'>" . $row['builtby'] . "</td>";
                ...
                $fitterSql = "SELECT fittername FROM fitters";
                $fitterResult = $conn->query($fitterSql);
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='fitter2' style='width:5%;'>";
                echo "<select class=\"drops1\" id=\"fitter2" . $row['jobid'] . "\" name=\"fitter2\"  style='$rowColorStyle'>";
                while ($fitterRow = $fitterResult->fetch_assoc()) {
                ...
                $fitterSql = "SELECT fittername FROM fitters";
                $fitterResult = $conn->query($fitterSql);
                echo "<td contenteditable='true' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='fitter3' style='width:5%;'>";
                echo "<select class=\"drops1\" id=\"fitter3" . $row['jobid'] . "\" name=\"fitter3\"  style='$rowColorStyle'>";
                while ($fitterRow = $fitterResult->fetch_assoc()) {
