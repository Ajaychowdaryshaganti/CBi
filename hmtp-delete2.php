...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if (mysqli_stmt_execute($stmt)) {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                $msg .= "<strong>Part No:</strong> " . $row['PartNo'] . "<br>";
				$msg .= "<strong>Supplier:</strong> " . $row['Supplier'] . "<br><br>";
				$flag=1;
    ...
    mysqli_stmt_close($stmt);
								...
								<form method=\"post\" id=\"myForm\" action=\"hmtp-delete3.php\">
									<h3>".$msg."</h3>
								...
								<h2>".$msg."</h2><br>
								<form method=\"post\" id=\"myForm\" action=\"hmtp-delete2.php\">
