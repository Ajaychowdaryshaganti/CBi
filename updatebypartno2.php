		...
		$result=mysqli_query($conn,$Query);
 			$record=mysqli_fetch_assoc($result);
				...
				if ($record) {
								...
								<form method=\"post\" id=\"myForm\" action=\"updatebypartno3.php\">
									<br><br>
							...
							"<br><br><a href=\"updatebypartno2-add.php\" id=\"no-fill\" class=\"updateadd\">ADD(+)</a><br><br>

							<a href=\"updatebypartno2-subtract.php\" id=\"no-fill\" class=\"updatesubtract\">SUBTRACT(-)</a>
								</form>";	
								}
								...
								echo " <div class=\"signup-container\"> 
									<div class=\"form-cube\"> <h1>
										PartNo :" .$partno. "<br><br> is not available in database" . mysqli_error($conn). 
										"</h1></div></div>";
					 }
}
			else {
