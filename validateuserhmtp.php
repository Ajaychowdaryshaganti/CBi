...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query = "SELECT fittername FROM fitters WHERE password='$userpin' and hmtp=1 ";
    ...
    echo " 
        ...
        <div class=\"signup-container\">
			...
			<h2>Hello " . $fittername . "</h2><br>
                ...
                </div><center><a id=\"\" class=\"ri-logout-circle-line\" href=\"hmtpindex.html\">Logout</a></center>
            </div> 
</div>
</form> ";
} else {
    echo "
<form method=\"get\" id=\"myForm\" action=\"validateuserhmtp.php\">
	<br><br>
	<div class=\"signup-container\"> 
            <!-- Box container containing elements -->
            <div class=\"form-cube\"> 
