...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($required > 0) {
        ...
        $selectQuery = "SELECT * FROM reorderlabels WHERE PartNo = ?";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $updateQuery = "UPDATE reorderlabels
            SET Required = ?,
            ...
            // Insert a new record
            $insertQuery = "INSERT INTO reorderlabels (BinLocation, PartName, PartNo, Category, Required, BackOrder, PurchaseOrder, Comments)
            SELECT BinLocation, PartName, ?, 'Labels', ?, (? - 0), 'NA', 'NA' FROM labels WHERE PartNo = ?";
...
<section id="page-top-2">
    ...
    <br>
    <h4 class="white-txt center"><center><strong>Welcome to Labels Re-Order Console</strong><center></h4>
</section>
