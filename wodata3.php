    ...
    try {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td contenteditable='false' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='fitter1' style='width:5%;'>";
                ...
                $fitterSql = "SELECT fittername FROM fitters";
                $fitterResult = $conn->query($fitterSql);
                echo "<td contenteditable='false' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='fitter3' style='width:5%;'>";
