...
DATE</th><th>ENC DATE</th><th>PART AVA</th><th>ETD</th><th>COMP %</th><th>REM HRS</th><th>FITTER1</th><th>MANAGER</th><th>STATUS</th><th>TYPE</th><th>COMMENTS1</th><th>COMMENTS2</th><th>LAST UPDATED</th><th>LAST UPDATE BY</th><th>FITTER2</th><th>FITTER3</th></strong></tr>";
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              $color = '#ffff00'; // Yellow color for InProgress
				...
				echo "<td contenteditable='false' class='editable' data-jobid='" . $row['jobid'] . "' data-columnname='currentstate'>" . $row['currentstate'] . "</td>";
            ...
            echo "<tr id='lastrow'><td></td><td></td><td colspan='3' style='text-align: right;'>Total Work Hrs:</td><td id='wrkhrs'>$totalworkhrs</td><td></td><td  colspan='3' style='text-align: right;'>Total Rem Hrs:</td><td id='remhrs'>$totalremhrs</td></tr></table>";
