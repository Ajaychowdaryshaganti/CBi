    ...
    <body>
        ...
        <header>
            <nav> 
                ...
                <ul>
                        <li><a href="Dashboard.html" id="select"><p>Dashboard</p></a></li>
...
<div id="contentContainer"><form method="post" id="myForm" action="updatebybin2.php">
        <br><br>
        <div class="signup-container"> 
            ...
            <div class="form-cube"> 
                ...
                <div class="input-field" id="idFld"> 
                    <input type="text" id="barcodeInput" name="binlocation">
                </div>
            </div>
        </div>
    </form></div>
